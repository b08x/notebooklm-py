...
from sqlalchemy import DateTime, ForeignKey, Index, Integer, String, Text, func, literal_column
...
class Embedding(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    clause_id: Mapped[str] = mapped_column(String, ForeignKey("clauses.external_id", ondelete="CASCADE"), nullable=False)
